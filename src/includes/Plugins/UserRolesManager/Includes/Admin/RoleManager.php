										...
										<div class="card-body d-flex flex-column align-items-center gap-3">
											<div class="wikipress-capability-title d-flex align-items-center justify-content-center gap-1">
												...
												<?php if ( $wordpress_description ) : ?>
													<button type="button" class="btn btn-sm btn-outline-secondary wikipress-capability-info p-0" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="<?php echo esc_attr( $wordpress_description ); ?>" aria-label="<?php esc_attr_e( 'Capability information', 'wikipress' ); ?>">
